...
class Blockchain(object):
    ...
    def hash(block):
        ...
        """
        # Ensure that the `block` dictionary is ordered, or we'll have
        # inconsistent hashes
    ...
    def proof_of_work(self, last_proof):
        ...
        - Find a number p' such that hash(pp') contains leading four zeros,
    ...
    def valid_proof(last_proof, proof):
        ...
        Does hash(last_proof, proof) contain four leading zeros?
    ...
    def register_node(self, address):
        ...
        ----------
        address: str
            Address of node. e.g. 'http://192.168.0.5:5000'
    ...
    def resolve_conflicts(self):
        """Consensus Algorithm for valid chains
        ...
        # We only want to consider chains longer than our own
        max_length = len(self.chain)

        # Verify chains from all the nodes in our network
        ...
        # Replace chain if we discovered a new, valid, longer chain
        if new_chain:
